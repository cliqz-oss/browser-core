...
describe('Offers Hub UI tests', function () {
  ...
  function headerTests() {
    it('renders gift icon', function () {
      expect(subject.query('.header__myoffrz-logo')).to.exist;
    });
  ...
  function footerTests() {
    ...
    it('renders logo', function () {
      expect(subject.query('.footer__myoffrz-logo')).to.exist;
    });
  }
  ...
  context('offer with optional data', function () {
    ...
    it('with labels', function () {
      expect(subject.query('.card-header__exclusive')).to.exist;
      expect(subject.query('.card-header__best_offer')).to.exist;
      expect(subject.query('.card-header__exclusive')).to.have.text('offers_exclusive');
      expect(subject.query('.card-header__best_offer')).to.have.text('offers_best_offer');
    });
