...
export default class SerpPageVariation extends React.Component {
  ...
  updateSearchboxValue = (nextValue) => {
    ...
    this._querySuggestionsTimer = setTimeout(() => {
      // If a nextValue is empty (search box value is empty)
      // and the last this._querySuggestionsTimer has been executed
      // before it's cleared by the line 239,
      // then we still need to close querySuggestions.
      // This case is rarely to be there but needs to be handled.
