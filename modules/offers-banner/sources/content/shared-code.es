...
// Copy 2: offers-banner/content/shared-code.es
//
 ...
 */
export function getElementByConfigFieldName(document, elemId) {
  return elemId
 ...
 */
export function getCouponsForm(window, couponInfo = {}) {
  ...
  if (inputExplicit && submitExplicit) {
    return { ok: true, input: inputExplicit, button: submitExplicit };
  }
