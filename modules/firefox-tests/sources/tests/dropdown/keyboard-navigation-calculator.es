...
export default function () {
  context('keyboard navigation for simple result and calculator result', function () {
    ...
    context('press arrowUp', function () {
      ...
      it('press arrowUp again - onle "search with" result is selected', function () {
        press('ArrowUp', 'ArrowUp');
        return waitFor(function () {
          return !result1Element.classList.contains('selected');
        }).then(function () {
    ...
    context('press arrowLeft', function () {
      ...
      it('press arrowDown - "search with", calculator, and simple results were rendered', function () {
        press('ArrowDown', 'ArrowDown');
        return waitForPopup().then(function () {
          resultElement = $cliqzResults()[0];
        }).then(function () {
