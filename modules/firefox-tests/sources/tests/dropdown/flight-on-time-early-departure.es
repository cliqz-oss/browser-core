...
import results from './fixtures/resultsFlightOnTimeEarlyDep';

export default function () {
  context('for flight results when flight is on time, departed early', function () {
