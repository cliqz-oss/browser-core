...
import results from './fixtures/resultsFlightDelayedNoUpdates';

export default function () {
  context('for flight results when flight has been delayed without updates', function () {
    ...
    ['depart', 'arrival'].forEach(function (flight, i) {
      context(`for ${flight} info`, function () {
        ...
        it(`renders existing and correct ${flight} times`, function () {
          ...
          chai.expect(flightActTimeItem).to.be.empty;
