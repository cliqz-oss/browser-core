  ...
  describe("extensions", function() {
      ...
      describe('assimilation', function() {
        ...
        it('should assimilate two levels deep, for fulfillment of self fulfilling promises', function(done) {
          ...
          promise.then(function(value) {
            ...
            assert(reason.constructor.name === "TypeError");
            done();
          });
        });
    ...
    function assertRejection(promise) {
      return promise.then(function(){
        ...
        assert(reason.constructor.name === "Error" || reason.constructor.name === "TypeError");
      });
    }
    ...
    describe('race', function() {
      ...
      it("throws when not passed an array", function(done) {
        try {
        var nothing = assertRejection(Promise.race()).catch(done);
        var string  = assertRejection(Promise.race('')).catch(done);
        var object  = assertRejection(Promise.race({})).catch(done);
