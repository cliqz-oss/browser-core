export default describeModule("telemetry/aggregators/behavior",
  function () {
    return {
      "telemetry/simple-statistics": {
        default: { mean: () => 'mean' },
      },
    }
  },
  function () {
    ...
    describe("#describeIntervalSeries", function () {
      ...
      var maxSeries;
      beforeEach(function() {
        this.deps("telemetry/simple-statistics").default.mean = (series) => { meanSeries = series; return 'mean'; };
        this.deps("telemetry/simple-statistics").default.median = (series) => { medianSeries = series; return 'median'; };
        this.deps("telemetry/simple-statistics").default.standardDeviation = (series) => { stdevSeries = series; return 'stdev'; };
        this.deps("telemetry/simple-statistics").default.min = (series) => { minSeries = series; return 'min'; };
        this.deps("telemetry/simple-statistics").default.max = (series) => { maxSeries = series; return 'max'; };
      });
    ...
    describe("#aggregate", function () {
      var aggregator, records, blacklist;
      beforeEach(function() {
        this.deps("telemetry/simple-statistics").default.mean = () => 'mean';
        this.deps("telemetry/simple-statistics").default.median = () => 'median';
        this.deps("telemetry/simple-statistics").default.standardDeviation = () => 'stdev';
        this.deps("telemetry/simple-statistics").default.min = () => 'min';
        this.deps("telemetry/simple-statistics").default.max = () => 'max';
      ...
      it("should return interval description for key_1 and categorical description for key_2", function () {
      ...
      it("should return total count if signal has no keys", function () {
