    ...
    <div class="cqz-local-info cqz-col-9">
        ...
        <ul class="cqz-local-info-box">
            ...
            <li class="cqz-local-address" extra="address" show-status='true' url="{{mu}}">
                <img src="https://cdn.cliqz.com/extension/EZ/local/map-pin.svg" class="cqz-local-icon clz_link" onerror="this.style.display='none';"/>
                <span>{{address}}</span>
            </li>
            {{/if}}
            {{!-- #if url_ratingimg}}
            ...
            <li>
                ...
                <div class="cqz-local-phone" extra="phone_num" cliqz-action="copy_val">
                    <img src="https://cdn.cliqz.com/extension/EZ/local/phone-1.svg" class="cqz-local-icon clz_copy" onerror="this.style.display='none';"/>
                ...
                <div class="cqz-local-time" extra="open-hour">
                    <div class="cqz-local-time-open-hour">
                        <img src="https://cdn.cliqz.com/extension/EZ/local/clock.svg" class="cqz-local-icon" onerror="this.style.display='none';"/>
