...
afterEach(() => {
  return Promise.resolve(attrack.unload())
...
describe('QSWhitelist', function() {
  ...
  describe('isUpToDate', function() {
    ...
    describe('after list update', function() {
      ...
      beforeEach(function() {
        ...
        return Promise.all([
          testServer.registerPathHandler('/token_whitelist.json', mock_token_string),
          testServer.registerPathHandler('/safekey.json', mock_safekey_string),
          testServer.registerPathHandler('/unsafekey.json', mock_unsafekey_string),
          testServer.registerPathHandler('/tracker_domain.json', mock_tracker_string),
        ])
        .then(() => whitelist.init())
  ...
  describe('_loadRemoteTokenWhitelist', function() {
    ...
    beforeEach(function() {
      mock_token_url = testServer.getBaseUrl('token_whitelist.json');
      mock_tracker_url = testServer.getBaseUrl('tracker_domain.json');
  ...
  describe('_loadRemoteSafeKey', function() {
    ...
    beforeEach(function () {
      ...
      persist.setValue('safeKeyExtVersion', '');
      return testServer.registerPathHandler('/safekey.json', mock_safekey_string);
    });
