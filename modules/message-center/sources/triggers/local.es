...
export default function getLocalMessages() {
  const LOCAL_DATA = [
    ...
    },
    {
      ...
      version: 1,
      type: 'notification',
      title: getMessage('freshtab_app_middle_box_new_cliqz_tab_hdr'),
      description: getMessage('freshtab_app_middle_box_new_cliqz_tab_desc'),
      icon: './images/settings-icon_blue.svg',
      cta_text: getMessage('freshtab_app_middle_box_new_cliqz_tab_cta'),
    ...
    },
    {
      ...
      version: 1,
      type: 'notification',
      title: getMessage('freshtab_app_middle_box_blue_theme_hdr'),
      description: getMessage('freshtab_app_middle_box_blue_theme_desc'),
      icon: './images/settings-icon_blue.svg',
      cta_text: getMessage('freshtab_app_middle_box_blue_theme_cta'),
      cta_url: 'home-action:settings',
      handler: 'MESSAGE_HANDLER_FRESHTAB_MIDDLE',
      position: 'middle',
      rules: [
    ...
    },
    {
      ...
      version: 1,
      type: 'notification',
      title: getMessage('freshtab_app_middle_box_french_news_hdr'),
      description: getMessage('freshtab_app_middle_box_french_news_desc'),
      icon: './images/settings-icon_blue.svg',
      cta_text: getMessage('freshtab_app_middle_box_french_news_cta'),
    ...
    },
    {
      ...
      version: 1,
      type: 'notification',
      title: getMessage('freshtab_app_middle_box_promote_mobile_hdr'),
      description: getMessage('freshtab_app_middle_box_promote_mobile_desc'),
      handler: 'MESSAGE_HANDLER_FRESHTAB_MIDDLE',
      position: 'middle',
      buttons: [
        {
    ...
    },
    {
      ...
      description: getMessage('freshtab_app_middle_box_ft_amo_desc'),
      cta_text: getMessage('freshtab_app_middle_box_ft_amo_cta'),
      cta_url: 'home-action:settings',
      handler: 'MESSAGE_HANDLER_FRESHTAB_TOP',
      position: 'top',
      rules: [
