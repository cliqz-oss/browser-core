...
export const flightMatrix = {
  ...
  arrivedAllLate: {
    ...
    statusColor: colors.red, // should be green
    icon: 'red-outline', // should be green-outline
    airport: colors.grey,
    depart: {
      estimate: {
        isShown: true,
  ...
  cancelled: {
    ...
    icon: 'red', // should be red-outline
    airport: colors.grey,
    depart: {
      estimate: {
        isShown: false,
  ...
  delayedNoUpdates: {
    ...
    statusColor: colors.green, // should be red
    icon: 'green', // should be red
    airport: colors.grey,
    depart: {
      estimate: {
        isShown: false,
  ...
  noInfo: {
    ...
    statusColor: colors.green, // should be lightGrey
    icon: 'green', // should be false
    airport: colors.grey,
    depart: {
      estimate: {
        isShown: false,
