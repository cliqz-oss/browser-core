...
describe('Fresh tab most visited', function () {
  ...
  describe('when set to be visible', function () {
    ...
    it('has visible area with dials', function () {
  ...
  describe('when set to not be visible', function () {
    ...
    it('has no visible area with dials', function () {
      chai.expect(subject.query(mostVisitedAreaSelector)).to.not.exist;
    });
  });

  describe('when has no deleted items', function () {
  ...
  describe('when has some deleted items', function () {
    beforeEach(function () {
      subject.respondsWith({
        module: 'freshtab',
        action: 'checkForHistorySpeedDialsToRestore',
    ...
    for (let i = 0; i < historyResponse.length; i++) {
      context(`with ${i + 1} elements`, function () {
        ...
        describe('area', function () {
          it('has existing label', function () {
            chai.expect(subject.query(mostVisitedHeaderSelector)).to.exist;
          });

          it('has correct amount of elements', function () {
        ...
        describe('each element', function () {
          ...
          it('has existing square logos with correct background color', function () {
          ...
          it('has existing and correct two chars on logos', function () {
          ...
          it('has existing and correct link titles', function () {
          ...
          it('has existing and correct links', function () {
          ...
          it('has existing and correct descriptions', function () {
          ...
          it('has existing delete buttons', function () {
