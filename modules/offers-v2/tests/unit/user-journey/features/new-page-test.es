  ...
  () => {
    describe('add a step to user journey', function () {
      ...
      it('/notify collector about main search engines', () => {
        const fixture = [
          'http://www-42.google.co.uk/search.php',
          'https://Bing.cn',
          'http://Yandex.ru',
          'https://ch-www.Baidu.com',
          'http://Yahoo.co.uk',
      ...
      it('/notify collector about meta search', () => {
        const fixture = [
          ...
          'https://suche.t-online.de/fast-cgi/tsc?sr=ptoweb&q=bayern', // FIXME
          'https://suche.web.de/web/result?origin=HP&q=fu%C3%9Fball', // FIXME
          'https://suche.gmx.net/web/result?origin=HP&q=bier', // FIXME
