export default {
  'hyphenate-headline': {
    ...
    template_data: {
      ...
      logo_class: 'normal',
      titleColor: '#56a699',
      headline: 'Rindfleischetikettierungsüberwachungsaufgabenübertragungsgesetz für Online Supermarket Lieferservice gutschein für Online Supermarket Lieferservice',
      benefit: '11%',
