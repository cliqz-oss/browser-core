...
export default describeModule('antitracking/attrack-bloom-filter',
  ...
  () => ({
    ...
    beforeEach(async function () {
      const BloomFilter = (await this.system.import('core/bloom-filter')).default;
      md5 = (await this.system.import('core/helpers/md5')).default;

      const AttrackBloomFilter = this.module().default;
