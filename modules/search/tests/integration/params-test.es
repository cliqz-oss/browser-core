  ...
  context('parameters test', function () {
    ...
    context('session', function () {
      ...
      context('blur urlbar and type new query', function () {
        beforeEach(async function () {
          const newQuery = 'new query';
          parameters = await getSearchParams(newQuery, { resultsNumber: 2 });
        });
    ...
    context('_sessionSeq and _queryCount', function () {
      beforeEach(async function () {
        restorePref = await mockPref('modules.context-search.enabled', false);
    ...
    context('language', function () {
      before(async function () {
        restorePref = await mockPref('data', '{"de":[-20,-213,-128,-164,-242,86,104,213,242,-6,-180,-36,197,32,-96,-216,-7,160,-90,-65,194,254,239,18,-229,170,-133,63,-251,127,-63,-102,78,-112,-210,199,61,209,-148],"en":[98,-111,-167,-56,246,137,-172,227,-176,-42,-180,194,223,-2,-92,157,89,234,-95,135,125,213,6,-179,-203,-58,184,-10,-208,-7,130,-138,-88,-187,-246,-91,66,195,83,-148,1,101,-77,-151,-102,110,14,-185,128,70,-216,-236,39,18,146,108,-242,-31,165,206,-139,-202,-222,-251,203,-63,-50,226,-248,-219,105,-254,10,180,63,13,210,238,93,-87,199,-164,30,235,-241,-192,44,64,127,-26,-23,-142,-97,-156,252,61,91,-255],"ru":[-56,24,-79,157,-62,7,-210,15,-207,147,108,44,227,145,152,162,-104,140,153,205,-85,73,42,-214,176,-202],"fr":[-73,-111,199],"el":[-28],"sv":[0]}', 'extensions.cliqz-lang.');
    ...
    context('locale', function () {
      ['de', 'en-US', 'fr'].forEach(function (locale) {
