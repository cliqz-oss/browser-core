...
var EXPORTED_SYMBOLS = ['CliqzPlacesAutoComplete'];
 ...
 *
 * @param aAutocomplete
 *        A reference to a CliqzPlacesAutoComplete.
 * @param aCallback
...
////////////////////////////////////////////////////////////////////////////////
//// CliqzPlacesAutoComplete class
//// @mozilla.org/autocomplete/search;1?name=history

function CliqzPlacesAutoComplete()
{
  ...
  function baseQuery(conditions = "") {
    //(h.frecency > 20 OR h.last_visit_date > (strftime('%s', date('now', '-6 months'))*1000000))
  ...
  XPCOMUtils.defineLazyGetter(this, "_db", function() {
    ...
    let stmt = db.createAsyncStatement("PRAGMA cache_size = -24576"); // 6MiB
    stmt.executeAsync();
    stmt.finalize();
...
CliqzPlacesAutoComplete.prototype = {
  //////////////////////////////////////////////////////////////////////////////
                                                         ...
                                                         aTokens)
  {
    ...
    if (aMatchBehavior === MATCH_ANYWHERE){
      params.searchBehavior |= Ci.mozIPlacesAutoComplete.BEHAVIOR_TYPED;
    }else{
  ...
  _xpcom_factory: XPCOMUtils.generateSingletonFactory(CliqzPlacesAutoComplete),
...
var components = [CliqzPlacesAutoComplete, urlInlineComplete];
