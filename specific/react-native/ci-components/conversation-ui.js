...
console.log(BasicApp);



const queryCliqz = (app, query="") => {
  app.availableModules.core.background.actions.queryCliqz(query);
  return false;
};

const openUrl = (app, url) => {
...
export default class extends React.Component {
  ...
  render() {
    let content;
    const actions = {
      queryCliqz: queryCliqz.bind(null, this.app),
      openUrl: openUrl.bind(null, this.app),
      openTab: openTab.bind(null, this.app),
      getOpenTabs: getOpenTabs.bind(null, this.app),
      getReminders: getReminders.bind(null, this.app),
    };
