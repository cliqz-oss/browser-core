            ...
            if (CliqzLanguage.currentState[lang].length > (CliqzLanguage.DOMAIN_THRESHOLD + 1)){
                ...
                if (prob <= 0.05){
                    ...
                    if (CliqzLanguage.currentState[lang][ind] != CliqzLanguage.LOCALE_HASH)
                    {
                        ...
                        utils.log("Removing hash " + CliqzLanguage.currentState[lang][ind] +
