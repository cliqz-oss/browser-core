...
module.exports = (base) => ({
  ...
  ENDPOINT_CONFIGURL: 'https://safe-browsing.'+base+'/config',
  ENDPOINT_HPNV2_COLLECTOR: 'https://collector-hpn.'+base+'',
  ENDPOINT_HPNV2_CONFIG: 'https://collector-hpn.'+base+'/config',
  ENDPOINT_HPNV2_JOIN: 'https://collector-hpn.'+base+'/join',
  ...
  JOBS_URL: 'https://'+base+'/jobs/', // autocomplete/sources/result-providers.es
  ...
  RICH_HEADER_PROXY_URL: 'hb-news.'+base+'',
