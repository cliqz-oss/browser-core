...
const id = 'nhceipmndngbhhhadbohlngbaehbiogj';

module.exports = Object.assign({}, configBase, {
  publish: publish.toPrereleaseFullName('chip_sparalarm', 'offers_pre', 'edge', 'zip'),
  settings: Object.assign({}, configBase.settings, {
    id,
    name: 'chipAppName',
    description: 'chipAppDesc',
    storeName: id,
    channel: 'MC20', // CHIP Sparalarm Edge Release
    OFFERS_CHANNEL: 'chip',
    OFFERS_BRAND: 'chip',
